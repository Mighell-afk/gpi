...
"")
        ...
        self.cbo_Facultad.setMouseTracking(True)

        self.gridLayout.addWidget(self.cbo_Facultad, 2, 1, 1, 1)
    ...
    def retranslateUi(self, CargarFacultad):
        ...
        self.label.setText(QCoreApplication.translate("CargarFacultad", u"Modificar Carrera", None))
