...
"")
        ...
        self.btn_guardar_malla.setGeometry(QRect(440, 580, 111, 30))
...
"")
        ...
        self.table_materia.setGeometry(QRect(10, 341, 970, 220))
        self.table_materia.setMinimumSize(QSize(970, 220))
