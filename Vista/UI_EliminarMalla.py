...
################################################################################
## Form generated from reading UI file 'eliminar_malla.ui'
##
...
"")
        ...
        self.btn_eliminar = QPushButton(EliminarMalla)
        self.btn_eliminar.setObjectName(u"btn_eliminar")
        self.btn_eliminar.setEnabled(False)
        self.btn_eliminar.setGeometry(QRect(225, 230, 121, 41))
    ...
    def retranslateUi(self, EliminarMalla):
        ...
        self.label.setText(QCoreApplication.translate("EliminarMalla", u"Eliminar Malla", None))
        ...
        self.btn_eliminar.setText(QCoreApplication.translate("EliminarMalla", u"Eliminar", None))
    # retranslateUi
