...
################################################################################
## Form generated from reading UI file 'form_facultad.ui'
##
...
"")
        ...
        self.cbo_filterFacultad = QComboBox(self.groupBox_5)
        self.cbo_filterFacultad.addItem("")
        self.cbo_filterFacultad.addItem("")
        self.cbo_filterFacultad.addItem("")
        self.cbo_filterFacultad.setObjectName(u"cbo_filterFacultad")
        self.cbo_filterFacultad.setMinimumSize(QSize(200, 0))

        self.horizontalLayout_20.addWidget(self.cbo_filterFacultad)
...
"}")
        ...
        self.txtBuscarFacultad = QLineEdit(self.personas)
        self.txtBuscarFacultad.setObjectName(u"txtBuscarFacultad")

        self.horizontalLayout_21.addWidget(self.txtBuscarFacultad)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cbo_filterFacultad.setItemText(0, QCoreApplication.translate("MainWindow", u"Codigo", None))
        self.cbo_filterFacultad.setItemText(1, QCoreApplication.translate("MainWindow", u"Nombre facultad", None))
        self.cbo_filterFacultad.setItemText(2, QCoreApplication.translate("MainWindow", u"Siglas", None))
...
#if QT_CONFIG(tooltip)
        self.btn_modificar.setToolTip(QCoreApplication.translate("MainWindow", u"Modificar Cliente", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.txtBuscarFacultad.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Buscar...", None))
