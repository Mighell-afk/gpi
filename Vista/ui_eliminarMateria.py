...
################################################################################
## Form generated from reading UI file 'EliminarMateria.ui'
##
...
class Ui_EliminarMateria(object):
...
"")
        ...
        self.lbl_nombremateria = QLabel(self.gridLayoutWidget)
        self.lbl_nombremateria.setObjectName(u"lbl_nombremateria")

        self.gridLayout.addWidget(self.lbl_nombremateria, 1, 1, 1, 1)
        ...
        self.btn_eliminar = QPushButton(EstadoFacultad)
    ...
    def retranslateUi(self, EstadoFacultad):
        ...
        self.label.setText(QCoreApplication.translate("EstadoFacultad", u"Eliminar Materia", None))
        ...
        self.btn_eliminar.setText(QCoreApplication.translate("EstadoFacultad", u"Eliminar", None))
    # retranslateUi
