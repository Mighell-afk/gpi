...
from AnadirCarrera import AddCarrera
from Vista.UI_Carrera import Ui_MenuCarrera
from EliminarCarrera import eliminarCarrera
from ModificarCarrera import modificar
...
class carrera(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.carrera.btn_baja.clicked.connect(lambda:self.AbrirAltaBajaCarrera())
    ...
    def AbrirAltaBajaCarrera(self):
        self.facu = estadocarrera(self)
        self.facu.show()
